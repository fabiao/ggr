...
turtle::turtle(const char *filename, int sx, int sy, BITMAP *bmp, int i, turtle *p) : sprite(filename,bmp,sx,sy,i,p)
 {
...
void turtle::loadSample(const char *filename, int n)
 {
