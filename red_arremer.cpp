...
red_arremer::red_arremer(const char *filename, int sx, int sy, BITMAP *bmp, int i, red_arremer *p) : sprite(filename,bmp,sx,sy,i,p)
 {
  resetObj(true);
...
void red_arremer::loadSample(const char *filename, int n)
 {
