...
big_crab::big_crab(const char *filename, int sx, int sy, BITMAP *bmp, int i, big_crab *p) : sprite(filename,bmp,sx,sy,i,p)
 {
...
void big_crab::loadSample(const char *filename, int n)
 {
