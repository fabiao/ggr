...
magician::magician(const char *filename, int sx, int sy, BITMAP *bmp, int i, magician *p) : sprite(filename,bmp,sx,sy,i,p)
 {
...
void magician::loadSample(const char *filename, int n)
 {
