...
giant::giant(const char *filename, int sx, int sy, BITMAP *bmp, int i, giant *p) : sprite(filename,bmp,sx,sy,i,p)
 {
  min_x=0; max_x=0;
  ...
  ti[2]=new timer_D(4);  // Hitted time (stop time)
...
void giant::loadSample(const char *filename, int n)
 {
